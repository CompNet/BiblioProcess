...
//		articleMap.putAll(map);
		...
		// open the ISI file
		System.out.println("\nOpen the ISI file " + ISI_FILE);
		FileInputStream sFis = new FileInputStream(ISI_FILE);
		InputStreamReader sReader = new InputStreamReader(sFis);
		Scanner sScanner = new Scanner(sReader);
...
//	System.out.print("");
	...
	{	// open the JabRef file
		...
		InputStreamReader jrReader = new InputStreamReader(jrFis);
		Scanner jrScanner = new Scanner(jrReader);
...
//	private static final HashMap<String,Article> articleMap = new HashMap<String, Article>();
	...
	/////////////////////////////////////////////////////////////////
	/** ISI file */
	private static final String ISI_FILE = "C:/Users/Vincent/Documents/Travail/Ecrits/Network Extraction/ComDet Biblio/data/2012.07.13 - individual/_all.isi";
//	private static final String ISI_FILE = "C:/Documents and Settings/Vincent/Mes documents/Travail/Ecrits/Network Extraction/ComDet Biblio/data/2012.07.13 - individual/_all.isi";
	/** JabRef file */
	private static final String JABREF_FILE = "C:/Users/Vincent/Documents/Travail/Ecrits/Networks Analysis/Papiers/2012.1.Bouquin/review.bib";
//	private static final String JABREF_FILE = "C:/Documents and Settings/Vincent/Mes documents/Travail/Ecrits/Networks Analysis/Papiers/2012.1.Bouquin/review.bib";
}